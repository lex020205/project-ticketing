...
class VerifikasiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.verifikasi.index', compact('tickets'));
    }
    ...
    public function show(Ticket $ticket)
    {
        ...
        return view('admin.verifikasi.show', compact('ticket', 'progressList', 'lampiranList'));
    }
    ...
    public function verifikasi(Request $request, Ticket $ticket)
    {
        if ($ticket->status_ticket !== 'menunggu_verifikasi') {
            return redirect()
                ->route('admin.verifikasi.show', $ticket)

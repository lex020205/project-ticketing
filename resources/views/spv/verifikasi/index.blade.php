...
{{-- Ringkas: daftar ticket menunggu verifikasi (SPV). --}}
@extends('layouts.app')

@section('title', 'Verifikasi Ticket - SPV')
                ...
                <tbody>
                    ...
                    @forelse ($tickets as $ticket)
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('spv.verifikasi.show', $ticket) }}" class="btn btn-sm btn-outline-primary">Detail</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
